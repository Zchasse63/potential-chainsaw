...
import { DataBoundary, type BoundaryQuery } from "../src/components/data-boundary.jsx";

// The violation report is the contract — mock the telemetry funnel and assert
// against it (never a silent fallback).
