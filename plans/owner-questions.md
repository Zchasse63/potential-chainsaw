...
| A4 | **ClassPass payout per visit** — ✅ ANSWERED BY DATA 2026-07-18: ClassPass IS in use (182 bookings origin 'classpass'; 45 people derive as aggregator — BLOCKERS P1-3b). Remaining owner input: the payout-per-visit dollar figure for the revenue metric | Phase 2 | Aggregator revenue metric; the segment is real and populated |
